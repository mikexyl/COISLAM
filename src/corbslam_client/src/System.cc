...
namespace ORB_SLAM2 {
    ...
    System::System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor,
        ...
        mpViewer = new Viewer(this, mpFrameDrawer, mpMapDrawer, mpTracker, strSettingsFile, clientId);
        if (bUseViewer)
        ...
        System::System(const string &strVocFile, const string &strIIVocFile, const string &strSettingsFile, const eSensor sensor,
                       const bool bUseViewer, const int clientId) : mSensor(sensor), mbReset(false),
                                                                    mbActivateLocalizationMode(false),
                                                                    mbDeactivateLocalizationMode(false) {
            // Output welcome message
            ...
            //II
            mbifII=true;
            // mpCacher->loadIIVocabulary(strIIVocFile);
    ...
    cv::Mat System::TrackStereo(const cv::Mat &imLeft, const cv::Mat &imRight, const double &timestamp) {
      // cout<<"test TrackStereo"<<endl;
        ...
        // cout<<"test TrackStereo GrabImageStereo"<<endl;
    ...
    void System::SaveTrajectoryTUM(const string &filename) {
        ...
        for (list<cv::Mat>::iterator lit = mpTracker->mlRelativeFramePoses.begin(),
            ...
            f << setprecision(6) << *lT << " " << setprecision(9) << twc.at<float>(0) << " " << twc.at<float>(2) << " "
