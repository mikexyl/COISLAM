...
public:
    ...
    System(const string &strVocFile, const string &strIIVocFile, const string &strSettingsFile, const eSensor sensor, const bool bUseViewer = true, const int clientId = 1);
