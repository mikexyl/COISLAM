...
namespace CORBSLAM_SERVER{
    ...
    public:
        ...
        bool detectKeyFrameInServerMap( ServerMap * sMap, KeyFrame* tKF, cv::Mat &newPose, std::vector<KeyFrame *> &candidateKFs, bool ifII=false);
...
//custom code
private:
  bool ifInitGlobalMap[100];

public:
  bool iiFuseToGlobalMap( ServerMap * sMap);
