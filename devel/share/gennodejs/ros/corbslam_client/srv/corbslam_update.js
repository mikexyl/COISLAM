...
// (in-package corbslam_client.srv)
...
class corbslam_updateRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type corbslam_updateRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type corbslam_updateRequest
    let len;
    let data = new corbslam_updateRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new corbslam_updateRequest(null);
...
class corbslam_updateResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type corbslam_updateResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type corbslam_updateResponse
    let len;
    let data = new corbslam_updateResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new corbslam_updateResponse(null);
...
module.exports = {
  Request: corbslam_updateRequest,
  Response: corbslam_updateResponse,
  md5sum() { return '1aabe292bb21d2f96bb243920fb547e5'; },
  datatype() { return 'corbslam_client/corbslam_update'; }
};
