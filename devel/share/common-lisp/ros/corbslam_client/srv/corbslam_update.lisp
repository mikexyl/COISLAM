...
(cl:in-package corbslam_client-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <corbslam_update-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'corbslam_update-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name corbslam_client-srv:<corbslam_update-request> is deprecated: use corbslam_client-srv:corbslam_update-request instead.")))

(cl:ensure-generic-function 'CID-val :lambda-list '(m))
(cl:defmethod CID-val ((m <corbslam_update-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader corbslam_client-srv:CID-val is deprecated.  Use corbslam_client-srv:CID instead.")
  (CID m))

(cl:ensure-generic-function 'TYPE-val :lambda-list '(m))
(cl:defmethod TYPE-val ((m <corbslam_update-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader corbslam_client-srv:TYPE-val is deprecated.  Use corbslam_client-srv:TYPE instead.")
  (TYPE m))

(cl:ensure-generic-function 'COUNT-val :lambda-list '(m))
(cl:defmethod COUNT-val ((m <corbslam_update-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader corbslam_client-srv:COUNT-val is deprecated.  Use corbslam_client-srv:COUNT instead.")
  (COUNT m))

(cl:ensure-generic-function 'DATA-val :lambda-list '(m))
(cl:defmethod DATA-val ((m <corbslam_update-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader corbslam_client-srv:DATA-val is deprecated.  Use corbslam_client-srv:DATA instead.")
  (DATA m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<corbslam_update-request>)))
  ...
  "corbslam_client/corbslam_updateRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'corbslam_update-request)))
  "Returns string type for a service object of type 'corbslam_update-request"
  "corbslam_client/corbslam_updateRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <corbslam_update-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'corbslam_update-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name corbslam_client-srv:<corbslam_update-response> is deprecated: use corbslam_client-srv:corbslam_update-response instead.")))

(cl:ensure-generic-function 'ACK-val :lambda-list '(m))
(cl:defmethod ACK-val ((m <corbslam_update-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader corbslam_client-srv:ACK-val is deprecated.  Use corbslam_client-srv:ACK instead.")
  (ACK m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<corbslam_update-response>)))
  ...
  "corbslam_client/corbslam_updateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'corbslam_update-response)))
  "Returns string type for a service object of type 'corbslam_update-response"
  "corbslam_client/corbslam_updateResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'corbslam_update)))
  ...
  "corbslam_client/corbslam_update")