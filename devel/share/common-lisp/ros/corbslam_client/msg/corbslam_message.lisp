...
(cl:in-package corbslam_client-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <corbslam_message>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'corbslam_message)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name corbslam_client-msg:<corbslam_message> is deprecated: use corbslam_client-msg:corbslam_message instead.")))

(cl:ensure-generic-function 'TRANSM-val :lambda-list '(m))
(cl:defmethod TRANSM-val ((m <corbslam_message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader corbslam_client-msg:TRANSM-val is deprecated.  Use corbslam_client-msg:TRANSM instead.")
  (TRANSM m))

(cl:ensure-generic-function 'DATA-val :lambda-list '(m))
(cl:defmethod DATA-val ((m <corbslam_message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader corbslam_client-msg:DATA-val is deprecated.  Use corbslam_client-msg:DATA instead.")
  (DATA m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<corbslam_message>)))
  ...
  "corbslam_client/corbslam_message")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'corbslam_message)))
  "Returns string type for a message object of type 'corbslam_message"
  "corbslam_client/corbslam_message")
